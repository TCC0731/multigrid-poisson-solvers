...
OMP_RESULTS_DIR = RESULT_ROOT.parent / "omp"

if str(OMP_RESULTS_DIR) not in sys.path:
    sys.path.insert(0, str(OMP_RESULTS_DIR))
...
def plot_results(
    *,
    ...
    ax.set_title(f"$L_2$ Error vs N ({case}, OpenMP 3D)")
    ax.set_xlabel("N")
    ...
    ax.set_title(fr"$L_\infty$ Error vs N ({case}, OpenMP 3D)")
    ax.set_xlabel("N")
    ...
    ax.set_title(f"Iterations vs N ({case}, OpenMP 3D)")
    ax.set_xlabel("N")
    ...
    ax.set_title(f"Time vs N ({case}, OpenMP 3D)")
    ax.set_xlabel("N")
...
def run_analysis(
    *,
    ...
    for case in CASES:
        print("\n=======================")
        print(f"Running OpenMP 3D case: {case}")
        print("=======================\n")
