...
"""Plot CUDA MG omega-sweep figures from an existing ``results_all.csv``."""
...
from _sweep_plot_from_csv import plot_iter_time_2x2_from_csv
...
def build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Plot CUDA MG omega-sweep figures from an existing results_all.csv.")
