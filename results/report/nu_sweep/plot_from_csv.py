...
"""Plot CUDA MG nu-sweep figures from an existing ``results_all.csv``."""
...
def build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Plot CUDA MG nu-sweep figures from an existing results_all.csv.")
