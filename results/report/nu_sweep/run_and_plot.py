...
"""Generate CUDA MG nu-sweep tables and plots."""
...
def build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Build CUDA MG nu sweep tables and plots.")
    ...
    parser.add_argument(
        ...
        help="nu values to sweep.",
    )
    parser.add_argument("--omega", type=float, default=DEFAULT_OMEGA, help="Fixed MG omega value.")
...
def main() -> None:
    ...
    nu_values = tuple(sorted({positive_int(value, "nu") for value in args.nu}))
    grid_sizes = {
