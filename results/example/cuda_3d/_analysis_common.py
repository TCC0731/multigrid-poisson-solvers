...
CUDA_RESULTS_DIR = RESULT_ROOT.parent / "cuda"
...
def plot_results(
    *,
    ...
    ax.set_title(f"$L_2$ Error vs N ({case}, CUDA 3D)")
    ax.set_xlabel("N")
    ...
    ax.set_title(fr"$L_\infty$ Error vs N ({case}, CUDA 3D)")
    ax.set_xlabel("N")
    ...
    ax.set_title(f"Iterations vs N ({case}, CUDA 3D)")
    ax.set_xlabel("N")
    ...
    ax.set_title(f"Time vs N ({case}, CUDA 3D)")
    ax.set_xlabel("N")
...
def run_analysis(
    *,
    ...
    for case in CASES:
        print("\n=======================")
        print(f"Running CUDA 3D case: {case}")
        print("=======================\n")
